    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[55px] text-[40px] text-white ss:leading-[100.8px] leading-[75px]">
          Посетите серию <br className="sm:block hidden" />{" "}
            <span className="text-gradient">моих вебинаров</span>{" "} и узнайте ответы
          </h1>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={olzhas} alt="billing" className="w-[100%] h-[100%] relative z-[0] rounded-full" />
